...
<!--  -->
    ...
    <table border="1" cellspacing="0" width="100%">
        <thead style="background-color: #333; color: #fff; text-align: center;">
            <th style="text-align: center;" colspan="7">Data Pembelian</th>
            <tr>
        ...
        <tbody style="text-align: center;">
            ...
            foreach ($data_pembelian->result_array() as $key) :
                $tgl1=date('d-m-Y',strtotime($key['tgl_masuk']));
    ...
    <table border="1" cellspacing="0" width="100%">
        <thead style="background-color: #333; color: #fff; text-align: center;">
            <th style="text-align: center;" colspan="7">Data Penjualan</th>
            <tr>
                <th style="text-align: center;">No</th>
        ...
        <tbody style="text-align: center;">
            ...
            foreach ($data_penjualan->result_array() as $key) :
                $tgl1=date('d-m-Y',strtotime($key['tgl_pemesanan']));
