...
<div class="card">
  ...
  <div class="card-body">
    ...
    <a href="<?= site_url("barang_masuk/cetak")?>" target="__blank" class="btn btn-primary btn-sm">Cetak Seluruh Barang Masuk</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('barang_masuk/cetak2')?>" method="post">
