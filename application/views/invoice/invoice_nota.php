...
<table border="0" align="center" style="width:700px;border:none;">
        <tr>
            ...
            <th style="text-align:left;">: <?php echo $b['kode_invoice'];?></th>
...
<tfoot>
    ...
    <tr>
        ...
        <td style="text-align:right;"><?php echo 'Rp '.number_format($total=array_sum($total_beli));?></td>
    </tr>
</tfoot>
</table>
...
<table align="center" style="width:700px; border:none;margin-top:5px;margin-bottom:20px;">
    <tr>
        <td align="right">Banjarmasin, <?php echo date('d-M-Y')?></td>
    </tr>
    <tr>
        <td align="right"></td>
    </tr>
