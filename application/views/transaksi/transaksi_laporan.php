...
<div class="card">
  ...
  <div class="card-body">
    ...
    <a href="<?= site_url("transaksi/cetak")?>" target="__blank" class="btn btn-primary btn-sm">Cetak Seluruh transaksi</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('transaksi/cetak2')?>" method="post">
